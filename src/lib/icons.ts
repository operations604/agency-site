// `lucide-react` is aliased to this file in vite.config.ts. Importing the
// package root pulls the whole icon set into the dev module graph; deep
// per-icon imports keep it to the icons the site actually renders.
// Add a line here when a component starts using a new icon.

export type { LucideIcon, LucideProps } from "lucide-react/dist/lucide-react.d.ts";
